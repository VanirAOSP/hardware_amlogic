...
//ralink 
#define RALINK_DRIVER_KO "rt5370sta"
#define RALINK_DRIVER_KO2 "cfg80211"
...
int ralink_load_driver()
{
    ...
    snprintf(mod_path, SYSFS_PATH_MAX, "%s/%s.ko",WIFI_DRIVER_MODULE_DIR,RALINK_DRIVER_KO2);
    wifi_insmod(mod_path, DRIVER_MODULE_ARG);
    
    snprintf(mod_path, SYSFS_PATH_MAX, "%s/%s.ko",WIFI_DRIVER_MODULE_DIR,RALINK_DRIVER_KO);
